    ...
    <table class="table table-striped">
      ...
      if ($result) {
        ...
        while ($row = mysqli_fetch_array($result)) {
          ...
          echo "<td><form action='../app/Editreportpage.php' method='POST'><input type='hidden' name='ref' value='".$row["Case_ID"]."'/><input type='submit' name='submit-btn' value='Delete' /></form></td>";
          echo "</tr>";
